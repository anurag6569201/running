...
const participationConditions = [
  ...
  {
    title: "Eligibility",
    content: "To participate in the Athletics Kids Cup (AKC), you must meet the eligibility criteria, including age requirements, medical clearance, and parental consent."
  },
  {
  ...
  {
    title: "Liability",
    content: "By participating in the Athletics Kids Cup (AKC), you acknowledge and agree that the event organizers are not responsible for any accidents or injuries that may occur during the event."
  },
  {
    title: "Consent",
      ...
      <div className="container mt-5 mb-5">
        <div className="row justify-content-center">
          <div className="col-md-8 text-center">
            ...
            <p>By registering for and participating in the Athletics Kids Cup (AKC), you agree to the terms and conditions outlined below:</p>
          </div>
