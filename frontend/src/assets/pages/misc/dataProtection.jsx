...
const dataProtectionInfo = [
  ...
  {
    title: "Data Sharing",
    content: "We may share your personal information with third parties involved in organizing the Kids Talent Hunt (KTH) event, but only to the extent necessary to support event operations."
  },
  {
    title: "Data Rights",
      ...
      <div className="container mt-5 mb-5">
        <div className="row justify-content-center">
          <div className="col-md-8 text-center">
            ...
            <p>By registering for and participating in the Kids Talent Hunt (KTH), you agree to the collection, use, and processing of your personal information as described below:</p>
          </div>
