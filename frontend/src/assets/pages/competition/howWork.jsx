...
function HowWork() {
  return (
    <>
      <div>
        <div className="container howWcontainer">
          <div className="row justify-content-center align-items-center howWrow">
        ...
        <div className="container-fluid">
                <div className="row how_work_wrapper_row howWcontainer1">
